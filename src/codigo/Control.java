...
private class BloqueCondicion{
String etqVerdad, etqFalso;
}

private int actualTmp=0, actualEtq=0;
private String nuevaTmp(){
return "tmp"+(++actualTmp);
}
private String nuevaEtq(){
return "etq"+(++actualEtq);
}
private void usarASIG(String s, String e){
lineas.add("\n"+s+"="+e);
}
private String usarOpAritmetico(String e1, String e2, String op){
String tmp = nuevaTmp();
lineas.add("\n"+"\u005ct"+tmp+"="+e1+op+e2);
return tmp;
}
private void usarLabel(String label){
lineas.add("\n"+"label "+ label);
}
private void usarGoto(String label){
lineas.add("\n"+"\u005ctgoto "+ label);
}
private BloqueCondicion usarOpRelacional(String e1,
String e2,
String op){
BloqueCondicion blq = new BloqueCondicion();
blq.etqVerdad = nuevaEtq();
blq.etqFalso = nuevaEtq();
lineas.add("\n"+"\u005ctif "+ e1+op+e2 +" goto "+ blq.etqVerdad);
usarGoto(blq.etqFalso);
return blq;
}
private void intercambiarCondicion(BloqueCondicion blq){
...
| error ';'
*/
  final public void sentFinalizada() throws ParseException {
String s;
String e, ei;
BloqueCondicion c;
...
fact ::= ('-')* ( ID | NUMERO | '(' expr ')' )
*/
  final public String fact() throws ParseException {
String s, e, temporal;
...
*/
  final public BloqueCondicion cond() throws ParseException {
...
String e1, e2;
  ...
  final public String numero() throws ParseException {
  ...
  public ControlTokenManager token_source;
  ...
  public Control(java.io.InputStream stream, String encoding) {
    if (jj_initialized_once) {
      lineas.add("\n"+"ERROR: Second call to constructor of parser.  ");
